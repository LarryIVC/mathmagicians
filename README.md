...
**[Math Magicians]** It's a project for learning React.
...
```sh
  cd my-folder
  git git@github.com:LarryIVC/mathmagicians.git
```
...
Feel free to check the [issues page](https://github.com/LarryIVC/mathmagicians/issues).
...
Help me with your criticisms and your suggestions, you will be blessed for such a noble gesture and give me a ⭐️ if you like this project. click [here ⭐️](hhttps://github.com/LarryIVC/mathmagicians/stargazers)
